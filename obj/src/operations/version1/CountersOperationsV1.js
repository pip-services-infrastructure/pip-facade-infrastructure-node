...
class CountersOperationsV1 extends pip_services3_facade_node_1.FacadeOperations {
    constructor() {
        super();
        this._dependencyResolver.put('counters', new pip_services3_commons_node_1.Descriptor('pip-services-perfmon', 'client', '*', '*', '1.0'));
    }
    ...
    counterToText(counter) {
        ...
        if (counter.last != null)
            output += ", \"last\": " + pip_services3_commons_node_2.StringConverter.toString(counter.last);
        if (counter.count != null)
            output += ", \"count\": " + pip_services3_commons_node_2.StringConverter.toString(counter.count);
        if (counter.min != null)
            output += ", \"min\": " + pip_services3_commons_node_2.StringConverter.toString(counter.min);
        if (counter.max != null)
            output += ", \"max\": " + pip_services3_commons_node_2.StringConverter.toString(counter.max);
        if (counter.average != null)
            output += ", \"avg\": " + pip_services3_commons_node_2.StringConverter.toString(counter.average);
        if (counter.time != null)
            output += ", \"time\": " + pip_services3_commons_node_2.StringConverter.toString(counter.time);
        output += " }";
        return output;
    }
