...
class SettingsOperationsV1 extends pip_services_facade_node_1.FacadeOperations {
    constructor() {
        super();
        this._dependencyResolver.put('settings', new pip_services_commons_node_2.Descriptor('pip-services-settings', 'client', '*', '*', '1.0'));
    }
    ...
    clearSection(req, res) {
        let id = req.param('id') || req.param('section');
        this._settingsClient.setSection(null, id, new pip_services_commons_node_1.ConfigParams(), this.sendEmptyResult(req, res));
    }
}
