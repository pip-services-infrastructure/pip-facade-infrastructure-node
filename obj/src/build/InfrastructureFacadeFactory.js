...
class InfrastructureFacadeFactory extends pip_services3_components_node_1.Factory {
    constructor() {
        super();
...
InfrastructureFacadeFactory.Descriptor = new pip_services3_commons_node_1.Descriptor("pip-facade-infrastructure", "factory", "default", "default", "1.0");
InfrastructureFacadeFactory.LoggingOperationsV1Descriptor = new pip_services3_commons_node_1.Descriptor("pip-facade-infrastructure", "operations", "logging", "*", "1.0");
InfrastructureFacadeFactory.CountersOperationsV1Descriptor = new pip_services3_commons_node_1.Descriptor("pip-facade-infrastructure", "operations", "counters", "*", "1.0");
InfrastructureFacadeFactory.EventLogOperationsV1Descriptor = new pip_services3_commons_node_1.Descriptor("pip-facade-infrastructure", "operations", "eventlog", "*", "1.0");
InfrastructureFacadeFactory.SettingsOperationsV1Descriptor = new pip_services3_commons_node_1.Descriptor("pip-facade-infrastructure", "operations", "settings", "*", "1.0");
InfrastructureFacadeFactory.StatisticsOperationsV1Descriptor = new pip_services3_commons_node_1.Descriptor("pip-facade-infrastructure", "operations", "statistics", "*", "1.0");
InfrastructureFacadeFactory.BlobsOperationsV1Descriptor = new pip_services3_commons_node_1.Descriptor("pip-facade-infrastructure", "operations", "blobs", "*", "1.0");
InfrastructureFacadeFactory.EmailOperationsV1Descriptor = new pip_services3_commons_node_1.Descriptor("pip-facade-infrastructure", "operations", "email", "*", "1.0");
InfrastructureFacadeFactory.SmsOperationsV1Descriptor = new pip_services3_commons_node_1.Descriptor("pip-facade-infrastructure", "operations", "sms", "*", "1.0");
